                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="row" style="margin-right: 0; margin-left: 0;">
                                  ...
                                  @endif
                                  <div class="col-4" style="padding: 0;">
                                   <a href="#" class="btn btn-link qr {{str_contains($menu[0]->actions,'R') ? '' : 'disabled' }}" style="width:40px; margin: 0" data-toggle="modal" data-action="{{action('MainController@index')}}/slots4funtx/{{$r->id}}" data-id="ID: {{$r->id}}" data-target="#modalqr"><i class="fas fa-qrcode"></i></a>
                                 </div>
