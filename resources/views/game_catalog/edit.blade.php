              ...
              <div class="col-12 col-sm-6 col-md-4">
               ...
               <div class="col-12 col-sm-6 col-md-4" id="div_group1">
                <div class="form-group">
                  ...
                  <label><input type="checkbox" id="check_band" class="@error('band_select') is-invalid @enderror input100" name="band_select" value="1" {{$res->band_select == 1 ? 'checked' : ''}} /><span style="margin-left:10px">Allow Select Games</span></label>
                </div>
              </div>
