            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6 col-md-4">
                <div class="form-group">
                  ...
                  <label><input type="checkbox" class="@error('count_warehouse') is-invalid @enderror input100" name="count_warehouse" value="1" {{old('count_warehouse') == 1 ? 'checked' : ''}} /><span style="margin-left:10px">Without Warehouse</span></label>
                </div>
              </div>
